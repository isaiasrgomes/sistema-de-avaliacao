...
export default async function ProgramaPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Programa e prazos"
        description="Nome do edital, período de avaliações, quantidade de avaliadores por proposta e prorrogação única do prazo final. Lembretes por e-mail usam Resend (variáveis RESEND_API_KEY e EMAIL_FROM)."
      />
      {readonly ? (
